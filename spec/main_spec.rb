...
describe TOYROBOT::Main do
  describe '#parse_cmd' do
    ...
    describe @robot do
      ...
      let(:robot) {main.instance_variable_get(:@robot)}
      ...
      describe 'when ROTATE' do
        ...
        it 'should call the rotate with RIGHT' do
          expect(robot).to receive(:rotate).with('RIGHT')
          main.parse_cmd('RIGHT')
        end

        it 'should call the rotate with LEFT' do
          expect(robot).to receive(:rotate).with('LEFT')
          main.parse_cmd('LEFT')
        end

        it 'should not call rotate' do
          expect(robot).to_not receive(:rotate)
